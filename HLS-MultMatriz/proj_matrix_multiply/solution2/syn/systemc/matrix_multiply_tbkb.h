...
// ==============================================================
#ifndef __matrix_multiply_tbkb__HH__
#define __matrix_multiply_tbkb__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_multiply_tbkb) {
    ...
    SC_CTOR(matrix_multiply_tbkb):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
